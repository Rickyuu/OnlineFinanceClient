...
/**
 * Servlet implementation class UserViewApplyServlet
 */
@WebServlet("/UserViewApplyServlet")
public class UserViewApplyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UserViewApplyServlet() {
        super();
