...
/**
 * Servlet implementation class HostDisagreeFinanceServlet
 */
@WebServlet("/HostDisagreeFinanceServlet")
public class HostDisagreeFinanceServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HostDisagreeFinanceServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		DaoFactory.getFinanceApplyDao().updateApplyState(applyid, "主持拒绝");
